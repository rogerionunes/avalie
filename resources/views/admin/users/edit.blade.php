            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <select class="select2" data-placeholder="Selecione uma opção" name='tipoUsuario' style="width: 100%;" placeholder="Selecione uma Opção" require>
                    <option value=''></option>
                    <option value='P' @if ($user->tp_usuario == 'P') selected @endif>Professor</option>
                    <option value='C' @if ($user->tp_usuario == 'C') selected @endif>Coordenador</option>
                  </select>
                </div>
              </div>
            </div>
